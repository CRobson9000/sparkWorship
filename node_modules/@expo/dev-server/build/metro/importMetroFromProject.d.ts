...
export declare function importMetroHmrServerFromProject(projectRoot: string): any;
export declare function importMetroLibAttachWebsocketServerFromProject(projectRoot: string): any;
