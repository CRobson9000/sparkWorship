...
async function startDevServerAsync(projectRoot, startOptions) {
  var _projectConfig$exp$ex, _projectConfig$exp$ex2;
  ...
  const easProjectId = (_projectConfig$exp$ex = projectConfig.exp.extra) === null || _projectConfig$exp$ex === void 0 ? void 0 : (_projectConfig$exp$ex2 = _projectConfig$exp$ex.eas) === null || _projectConfig$exp$ex2 === void 0 ? void 0 : _projectConfig$exp$ex2.projectId;
  const useExpoUpdatesManifest = startOptions.forceManifestType === 'expo-updates' || startOptions.forceManifestType !== 'classic' && easProjectId; // We need the manifest handler to be the first middleware to run so our
