...
function createNativeDevServerMiddleware(projectRoot, {
  ...
  const useExpoUpdatesManifest = forceManifestType === 'expo-updates' || forceManifestType !== 'classic' && easProjectId;
...
async function startAsync(projectRoot, options = {}) {
  ...
  config.devServer.before = (app, server, compiler) => {
    ...
    if (nativeMiddleware !== null && nativeMiddleware !== void 0 && nativeMiddleware.middleware) {
