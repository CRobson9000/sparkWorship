...
function getDependenciesFromBundledNativeModules({
  ...
  const shouldUseExpoReactNativeFork = projectDependencies['expokit'] || workflow === 'managed' && targetSdkVersionString && _semver().default.lt(targetSdkVersionString, '43.0.0');
